...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        debug_args = [
            ...
            "--preview", "5",
            "--limit", "500",
            "--pred_sols_file", "pred/cap100/test_sols_pred_cap100_20251117_152019.npy"
        ]
    ...
    instances, pred_sols, opt_sols_file = load_data(args.dataset_dir,
                                                    args.capacity,
                                                    args.pred_sols_file)
    ...
    for i in range(n_instances):
        ...
        if i < args.preview:
            ...
            print(f"  optimal_obj (scaled by purchase_fee {args.purchase_fee}): {optimal_objs[i]:.6f}")
